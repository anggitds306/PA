        ...
        <div class="container">
            ...
            <div class="box">
                <form action="" method="POST">
                    ...
                    <input type="text" name="user" placeholder="Nama Username" class="input-control" value="<?php echo $d->username ?>" required>
        ...
        <h3>Ubah Password</h3>
            <div class="box">
                <form action="" method="POST">
                    ...
                    <input type="submit" name="ubah_password" value="Password" class="btn">
                </form>
                <?php
